...
//     .text(Math.round(score));
  ...
  function centroid(innerR, outerR, startAngle, endAngle){
   ...
   function showSlider(catId, score){
	document.getElementById("fader").value = score;
	document.getElementById("rate").innerHTML = score;
	document.getElementById("slider").style.display = "block";
	document.getElementById("selected_cat").value = catId;
   }
      ...
      // declare public variables and/or functions
		...
		var outerGroup = svg.selectAll(".solidArc")
			...
			outerGroup
			  ...
			  .on('click', function(d){showSlider(d.data.id,d.data.score);});
